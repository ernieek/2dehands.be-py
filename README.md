...
from 2dehands import Condition, SearchQuery, SortBy, SortOrder, category_from_name
...
## Categories
Filtering by 2dehands category is possible. Please refer to the categories index at [CATEGORIES.md](./CATEGORIES.md)
